...
//连接端口号:5500,可自行修改为其他端口.
const u8* portnum="5500";		 

//WIFI STA模式,设置要去连接的路由器无线参数,请根据你自己的路由器设置,自行修改.
const u8* wifista_ssid="fengzheng";			//路由器SSID号
const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
const u8* wifista_password="18290019557"; 	//连接密码
const u8* wifista_ipbuf="192.168.4.1";//IP缓存
